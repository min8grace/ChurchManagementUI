...
export default function OfferingMyMonthlyList() {
    ...
    const { isLoading, data: Offerings } = useQuery<IOfferings>([`OfferingsByOfferingNoAndMonth`, offeringNo, selectedYear, selectedMonth], GetOfferingsByOfferingNoAndMonth);
        ...
        >
            <Flex justifyContent={'space-between'} >
                <HStack width={"80%"} mt={-8} mb={5} >
                    ...
                    <Select width={"125px"} placeholder={selectedMonth ?? undefined} onChange={handleMonthChange} value={selectedMonth ?? undefined}>{
